...
from thegokil.errors import AuthBytesInvalid
from thegokil.session import Session
from thegokil.session.auth import Auth


async def get_session(client: "thegokil.Client", dc_id: int):
