...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~thegokil.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~thegokil.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~thegokil.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "thegokil". Get the first 50 results
                async for message in app.search_global("thegokil", limit=50):
                    print(message.text)
