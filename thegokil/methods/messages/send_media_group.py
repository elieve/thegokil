...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~thegokil.types.InputMediaPhoto`, :obj:`~thegokil.types.InputMediaVideo`, :obj:`~thegokil.types.InputMediaAudio` and :obj:`~thegokil.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~thegokil.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from thegokil.types import InputMediaPhoto, InputMediaVideo
