...
import thegokil
from thegokil import StopTransmission, enums
from thegokil import raw
from thegokil import types
from thegokil import utils
from thegokil.errors import FilePartMissing
from thegokil.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~thegokil.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~thegokil.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~thegokil.Client.stop_transmission`, None is returned.
