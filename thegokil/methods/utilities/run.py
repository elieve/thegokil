...
import thegokil
from thegokil.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~thegokil.Client.start`, :meth:`~thegokil.idle` and :meth:`~thegokil.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`thegokil.compose`.
