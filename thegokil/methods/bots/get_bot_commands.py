...
import thegokil
from thegokil import raw, types
...
class GetBotCommands:
    async def get_bot_commands(
        ...
        Parameters:
            scope (:obj:`~thegokil.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~thegokil.types.BotCommandScopeDefault`.
        ...
        Returns:
            List of :obj:`~thegokil.types.BotCommand`: On success, the list of bot commands is returned.
