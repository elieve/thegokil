...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~thegokil.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, thegokil.Client):
                self.add_handler(thegokil.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        thegokil.handlers.ChatMemberUpdatedHandler(func, self),
