...
class OnCallbackQuery:
    def on_callback_query(
        ...
        :obj:`~thegokil.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, thegokil.Client):
                self.add_handler(thegokil.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        thegokil.handlers.CallbackQueryHandler(func, self),
