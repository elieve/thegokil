...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~thegokil.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, thegokil.Client):
                self.add_handler(thegokil.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        thegokil.handlers.EditedMessageHandler(func, self),
