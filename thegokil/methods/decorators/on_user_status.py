...
class OnUserStatus:
    def on_user_status(
        ...
        :obj:`~thegokil.handlers.UserStatusHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, thegokil.Client):
                self.add_handler(thegokil.handlers.UserStatusHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        thegokil.handlers.UserStatusHandler(func, self),
