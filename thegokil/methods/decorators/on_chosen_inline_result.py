...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~thegokil.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, thegokil.Client):
                self.add_handler(thegokil.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        thegokil.handlers.ChosenInlineResultHandler(func, self),
