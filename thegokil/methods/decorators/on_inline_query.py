...
class OnInlineQuery:
    def on_inline_query(
        ...
        :obj:`~thegokil.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, thegokil.Client):
                self.add_handler(thegokil.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        thegokil.handlers.InlineQueryHandler(func, self),
