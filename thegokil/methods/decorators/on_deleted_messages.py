...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~thegokil.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, thegokil.Client):
                self.add_handler(thegokil.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        thegokil.handlers.DeletedMessagesHandler(func, self),
