...
from thegokil.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "thegokil.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~thegokil.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~thegokil.handlers.MessageHandler` the *update* argument will be a :obj:`~thegokil.types.Message`; in a :obj:`~thegokil.handlers.CallbackQueryHandler` the *update* will be a :obj:`~thegokil.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~thegokil.filters.command` or :meth:`~thegokil.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~thegokil.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~thegokil.types.Document` objects."""
...
"""Filter messages that contain :obj:`~thegokil.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~thegokil.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~thegokil.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~thegokil.types.Game` objects."""
...
"""Filter messages that contain :obj:`~thegokil.types.Video` objects."""
...
"""Filter messages that contain :obj:`~thegokil.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~thegokil.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~thegokil.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~thegokil.types.Location` objects."""
...
"""Filter messages that contain :obj:`~thegokil.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~thegokil.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~thegokil.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~thegokil.types.Message`.
    ...
    async def func(flt, client: thegokil.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~thegokil.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~thegokil.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~thegokil.types.InlineQuery`: The filter will match ``query``.
