...
from thegokil.crypto import aes, rsa, prime
from thegokil.errors import SecurityCheckMismatch
from thegokil.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "thegokil.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
