...
import thegokil
from thegokil import __version__, __license__
from thegokil import enums
from thegokil import raw
from thegokil import utils
from thegokil.crypto import aes
from thegokil.errors import CDNFileHashMismatch
from thegokil.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from thegokil.handlers.handler import Handler
from thegokil.methods import Methods
from thegokil.session import Auth, Session
from thegokil.storage import FileStorage, MemoryStorage
from thegokil.types import User, TermsOfService
from thegokil.utils import ainput
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~thegokil.Client.export_session_string` before stopping the client to get a session string you can
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~thegokil.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.thegokil.org/start/auth")
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except thegokil.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
