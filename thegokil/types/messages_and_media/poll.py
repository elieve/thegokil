...
import thegokil
from thegokil import raw, enums, utils
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        options (List of :obj:`~thegokil.types.PollOption`):
        ...
        explanation_entities (List of :obj:`~thegokil.types.MessageEntity`, *optional*):
