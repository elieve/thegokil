...
class Object:
    def __init__(self, client: "thegokil.Client" = None):
        self._client = client

    def bind(self, client: "thegokil.Client"):
        """Bind a Client instance to this and to all nested Pyrogram objects.

        Parameters:
            client (:obj:`~thegokil.types.Client`):
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/thegokilchat/167281
