...
import thegokil
from thegokil import enums, utils
...
class User(Object, Update):
    ...
    Parameters:
        ...
        is_support (``bool``, *optional*):
            True, if this user is part of the Telegram support thegokil.
        ...
        status (:obj:`~thegokil.enums.UserStatus`, *optional*):
            User's last seen & online status. ``None``, for bots.

        last_online_date (:py:obj:`~datetime.datetime`, *optional*):
            Last online date of a user. Only available in case status is :obj:`~thegokil.enums.UserStatus.OFFLINE`.

        next_offline_date (:py:obj:`~datetime.datetime`, *optional*):
            Date when a user will automatically go offline. Only available in case status is :obj:`~thegokil.enums.UserStatus.ONLINE`.
        ...
        emoji_status (:obj:`~thegokil.types.EmojiStatus`, *optional*):
            Emoji status.
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~thegokil.types.User`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~thegokil.types.User`.
    ...
    def block(self):
        """Bound method *block* of :obj:`~thegokil.types.User`.
    ...
    def unblock(self):
        """Bound method *unblock* of :obj:`~thegokil.types.User`.
    ...
    def get_common_chats(self):
        """Bound method *get_common_chats* of :obj:`~thegokil.types.User`.
