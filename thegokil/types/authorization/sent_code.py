...
class SentCode(Object):
    ...
    Parameters:
        type (:obj:`~thegokil.enums.SentCodeType`):
            Type of the current sent code.

        phone_code_hash (``str``):
            Confirmation code identifier useful for the next authorization steps (either
            :meth:`~thegokil.Client.sign_in` or :meth:`~thegokil.Client.sign_up`).

        next_type (:obj:`~thegokil.enums.NextCodeType`, *optional*):
            Type of the next code to be sent with :meth:`~thegokil.Client.resend_code`.

        timeout (``int``, *optional*):
            Delay in seconds before calling :meth:`~thegokil.Client.resend_code`.
    """
